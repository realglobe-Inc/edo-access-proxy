...
func parseParameters(args ...string) (param *parameters, err error) {
	...
	flags.StringVar(&param.sessLabel, "sessLabel", "X-Edo-Auth-Ta-Session", "Session label")
	...
	flags.StringVar(&param.filePref, "filePref", "edo-access-proxy", "Filename prefix for file buffer")
